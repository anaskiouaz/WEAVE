...
export default function Navigation() {
    ...
    // Liste des liens correspondant à tes routes dans App.jsx
    const navItems = [
        ...
        // Tu peux ajouter Admin ou Settings si tu veux, mais attention à la place sur petit écran
        // { path: '/admin', label: 'Admin', icon: Settings },
    ];

    return (
        <div className="fixed bottom-6 left-0 right-0 px-4 flex justify-center z-50 pointer-events-none">
            {/* pointer-events-auto est nécessaire pour réactiver les clics sur le menu lui-même */}
