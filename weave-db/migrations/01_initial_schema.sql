...
CREATE TABLE users (
    ...
    onboarding_role VARCHAR(50),            -- Colonne critique pour l'inscription
    phone VARCHAR(20),                      -- Colonne critique pour ton erreur
    birth_date DATE,
    medical_info TEXT,
...
CREATE TABLE tasks (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    reminder_sent BOOLEAN DEFAULT FALSE,    -- Colonne critique pour le cron
